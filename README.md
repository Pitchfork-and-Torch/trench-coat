...
[![status](https://img.shields.io/badge/status-1.3.1%20Circuit%20Desk-6b8f7a?style=for-the-badge&labelColor=0a0b14)](#development-roadmap)
...
<p align="center"><em>THE SHADOWS ARE YOUR ALLY | v1.3.1 Circuit Desk</em></p>
...
### Advanced install (editable clone)
...
| **7.3** | Hop Receipt | `trench receipt --json` (no secrets) - **v1.3.0** |
| **7.3.1** | Status Honesty | Pid fingerprint Disengage + hop probe CONNECT-refused is DEGRADED - **v1.3.1** |
...
| Project | Role |
|---------|------|
| [NetForge](https://github.com/Pitchfork-and-Torch/netforge) ([site](https://netforge.jonbailey.xyz/)) | Local DNS/TCP/metric hardening - not a proxy chain |
...
See also NetForge [SUITE.md](https://github.com/Pitchfork-and-Torch/netforge/blob/main/SUITE.md). The old `netforge-windows` / `linux` / `macos` repos are archived stubs.
