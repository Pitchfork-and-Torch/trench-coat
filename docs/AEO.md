...
**Version:** 1.1.0 Velvet Collar | **Canonical URL:** https://trenchcoat.jonbailey.xyz/
...
privacy cloak, multi-hop proxy, Tor SOCKS chain, fail-closed kill switch, open source opsec, legal anonymity tool, Command Nexus, Velvet Collar
